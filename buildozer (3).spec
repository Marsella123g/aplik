...
requirements = python3,kivy,kivymd,kivy-garden,numpy,matplotlib,pandas,kivy-garden.filebrowser,mysql,mysql-connector,mysql-connector-python,pillow,android
